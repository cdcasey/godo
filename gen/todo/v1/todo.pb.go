...
const file_todo_v1_todo_proto_rawDesc = "" +
	"\n" +
	"\x12todo/v1/todo.proto\x12\atodo.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfb\x01\n" +
	"\x04Todo\x12\x0e\n" +
	...
	"\x04todo\x18\x01 \x01(\v2\r.todo.v1.TodoR\x04todo\"\xb0\x01\n" +
	...
	"\n" +
	"DeleteTodo\x12\x1a.todo.v1.DeleteTodoRequest\x1a\x1b.todo.v1.DeleteTodoResponseB\x19Z\x17godo/gen/todo/v1;todov1b\x06proto3"
...
var file_todo_v1_todo_proto_depIdxs = []int32{
	...
	0,  // 4: todo.v1.GetTodoResponse.todo:type_name -> todo.v1.Todo
	...
	5,  // 8: todo.v1.TodoService.GetTodo:input_type -> todo.v1.GetTodoRequest
	...
	4,  // 12: todo.v1.TodoService.ListTodos:output_type -> todo.v1.ListTodosResponse
	6,  // 13: todo.v1.TodoService.GetTodo:output_type -> todo.v1.GetTodoResponse
